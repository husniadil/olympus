...
func TestInfoMarshalsToTheSpecShape(t *testing.T) {
	...
	}, `{"state":"present","session":{"name":"build","id":"$3","attached":false,"dead":false,"liveness":"present","cwd":"/repo"},"panes":[],"capabilities":{"native_scrollback":false,"views":false,"remain_on_exit":false,"server_env":false,"control_keys":false,"spawn_sizing":false,"spawn_command":false,"session_status":false,"tracks_alt_screen":false}}`)
}
...
func TestAbsentInfoCarriesNoSessionOrPanes(t *testing.T) {
	assertJSON(t, olympus.Info{
		...
		Capabilities: backend.Capabilities{Backend: backend.Zmx},
	}, `{"state":"absent","capabilities":{"native_scrollback":false,"views":false,"remain_on_exit":false,"server_env":false,"control_keys":false,"spawn_sizing":false,"spawn_command":false,"session_status":false,"tracks_alt_screen":false}}`)
}
...
func TestDiagnosisMarshalsToTheSpecShape(t *testing.T) {
	assertJSON(t, olympus.Diagnosis{
		...
		`"control_keys":false,"spawn_sizing":false,"spawn_command":false,"session_status":false,"tracks_alt_screen":false},`+
