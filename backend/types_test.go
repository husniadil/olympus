...
func TestCapabilitiesMarshalToTheSpecShape(t *testing.T) {
	...
	}, `{"native_scrollback":true,"views":false,"remain_on_exit":false,"server_env":false,"control_keys":false,"spawn_sizing":false,"spawn_command":false,"session_status":false,"tracks_alt_screen":false,"servers":false,"session_client":false,"bare":false,"focus":false}`)
}
